...
use MarekSkopal\ORMBenchmark\Propel\generated\Address;
...
class AddressTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.AddressTableMap';
     ...
     */
    public const OM_CLASS = '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\Address';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Address';
     ...
     */
    public const COL_ID = 'addresses.id';

    /**
     * the column name for the street field
     */
    public const COL_STREET = 'addresses.street';

    /**
     * the column name for the number field
     */
    public const COL_NUMBER = 'addresses.number';

    /**
     * the column name for the city field
     */
    public const COL_CITY = 'addresses.city';

    /**
     * the column name for the country field
     */
    public const COL_COUNTRY = 'addresses.country';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Street', 'Number', 'City', 'Country', ],
        self::TYPE_CAMELNAME     => ['id', 'street', 'number', 'city', 'country', ],
        self::TYPE_COLNAME       => [AddressTableMap::COL_ID, AddressTableMap::COL_STREET, AddressTableMap::COL_NUMBER, AddressTableMap::COL_CITY, AddressTableMap::COL_COUNTRY, ],
        self::TYPE_FIELDNAME     => ['id', 'street', 'number', 'city', 'country', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Street' => 1, 'Number' => 2, 'City' => 3, 'Country' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'street' => 1, 'number' => 2, 'city' => 3, 'country' => 4, ],
        self::TYPE_COLNAME       => [AddressTableMap::COL_ID => 0, AddressTableMap::COL_STREET => 1, AddressTableMap::COL_NUMBER => 2, AddressTableMap::COL_CITY => 3, AddressTableMap::COL_COUNTRY => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'street' => 1, 'number' => 2, 'city' => 3, 'country' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\Address');
        $this->setPackage('');
    ...
    {
        $this->addRelation('User', '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\User', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':address_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MarekSkopal\ORMBenchmark\Propel\generated\Address) { // it's a model object
