...
abstract class User implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of MarekSkopal\ORMBenchmark\Propel\generated\Base\User object.
     */
    ...
    public function setMiddleName($v)
    {
        ...
        if ($this->middle_name !== $v) {
            $this->middle_name = $v;
            $this->modifiedColumns[UserTableMap::COL_MIDDLE_NAME] = true;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[UserTableMap::COL_ADDRESS_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('AddressId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_MIDDLE_NAME)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDRESS_ID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_MIDDLE_NAME)) {
            $criteria->add(UserTableMap::COL_MIDDLE_NAME, $this->middle_name);
        }
        if ($this->isColumnModified(UserTableMap::COL_LAST_NAME)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDRESS_ID)) {
            $criteria->add(UserTableMap::COL_ADDRESS_ID, $this->address_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \MarekSkopal\ORMBenchmark\Propel\generated\User (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MarekSkopal\ORMBenchmark\Propel\generated\User Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
