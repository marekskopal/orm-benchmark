...
abstract class Address implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\Map\\AddressTableMap';
    ...
    /**
     * Initializes internal state of MarekSkopal\ORMBenchmark\Propel\generated\Base\Address object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AddressTableMap::translateFieldName('Country', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MarekSkopal\\ORMBenchmark\\Propel\\generated\\Address'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->usersScheduledForDeletion !== null) {
                if (!$this->usersScheduledForDeletion->isEmpty()) {
                    \MarekSkopal\ORMBenchmark\Propel\generated\UserQuery::create()
     ...
     * objects.
     *
     * @param object $copyObj An object of \MarekSkopal\ORMBenchmark\Propel\generated\Address (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MarekSkopal\ORMBenchmark\Propel\generated\Address Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initUsers(bool $overrideExisting = true): void
    {
        ...
        $this->collUsers->setModel('\MarekSkopal\ORMBenchmark\Propel\generated\User');
    }
        ...
        if (null === $this->collUsers || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collUsers) {
                    ...
                    $collUsers->setModel('\MarekSkopal\ORMBenchmark\Propel\generated\User');
